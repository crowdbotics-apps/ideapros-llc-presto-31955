...
## Project Structure
    ...
    ├── ideapros_llc_presto_31955  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_presto_31955`
...
2. Clone this repo and `cd ideapros_llc_presto_31955`
